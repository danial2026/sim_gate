...
- `app_version` (string, default: "0.0.5")
...
1. [ ] Initialize Flutter project with version 0.0.5
...
where `<VERSION>` is the app version from `pubspec.yaml` (e.g. `sim_gate-0.0.5-release.apk`).
